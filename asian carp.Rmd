...
## For black carp, if we remove the Southern Ukraine data (AAM = 11) point:
...
r_2 <- data.frame(
  Model = c("Simple linear", "Linear additive", "Interaction", "Grouped"),
  R2_before = c(summary(black.simple)$r.squared, summary(black.linear)$r.squared,
          summary(black.int)$r.squared, summary(black.group)$r.squared),
  R2_after = c(summary(black.simple.r)$r.squared, summary(black.linear.r)$r.squared,
          summary(black.int.r)$r.squared, summary(black.group.r)$r.squared)
)
kable(r_2)
```
...
```
>>>>>>> 5ccde3b196e0f34e3bf65968aaef25e7efdb2fc8
=======
---
title: "asian carp first part"
author: "Eddie Wu"
